...
public interface StickyHeaderAdapter<T extends RecyclerView.ViewHolder> {
     ...
     *
     * @param itemPosition the item adapter position
     * @return the header id, or {@link #NO_HEADER} if this item has no header.
     */
    long getStickyHeaderId(int itemPosition);
     ...
     */
    @NonNull
    T onCreateStickyHeaderHolder(ViewGroup parent);

    /**
     * Display the data at the specified position.
     * <p>
     *     PLEASE NOTE THE PARAM IS CHILD POSITION!
     *     IF YOU WANT TO USE HEADER ID, PLEASE CALL YOUR {@link #getStickyHeaderId(int)}.
     * </p>
     * @param holder the header view holder
     * @param itemPosition the child item position, can be used to retrieve header id.
     */
    void onBindStickyHeaderHolder(@NonNull T holder, int itemPosition);
}
