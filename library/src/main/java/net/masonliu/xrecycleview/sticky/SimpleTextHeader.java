...
public abstract class SimpleTextHeader implements StickyHeaderAdapter<SimpleHolder> {
    ...
    @NonNull
    @Override
    public SimpleHolder onCreateStickyHeaderHolder(ViewGroup parent) {
        TextView textView = createTextView(parent.getContext());
        return new SimpleHolder(textView);
    }

    @Override
    public void onBindStickyHeaderHolder(@NonNull SimpleHolder holder, int itemPosition) {
        ((TextView) holder.itemView).setText(getHeaderContent(itemPosition));
    }
}
